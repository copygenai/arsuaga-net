  ...
  es: {
    ...
    projects: {
      ...
      items: [
        ...
        {
          name: 'Civon',
          desc: 'Plataforma integral de movilización y recaudación para organizaciones alineadas con valores.',
          url: 'https://civon.org',
          emoji: '🏛️',
        },
      ],
  ...
  en: {
    ...
    projects: {
      ...
      items: [
        ...
        {
          name: 'Civon',
          desc: 'All in one mobilization and fundraising platform for values aligned organizations.',
          url: 'https://civon.org',
          emoji: '🏛️',
        },
      ],
