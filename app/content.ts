export const content = {
  es: {
    nav: { lang: 'EN', langHref: '/en' },
    hero: {
      name: 'Ignacio Arsuaga',
      subtitle: 'Fundador. Emprendedor. Activista.',
      scroll: 'Descubre más',
    },
    bio: {
      title: 'Sobre mí',
    ...
    projects: {
      ...
      items: [
        {
          name: 'CitizenGO',
          desc: 'Plataforma global de peticiones cívicas. Más de 19M de seguidores en 50 países.',
          url: 'https://citizengo.org',
          emoji: '🌍',
        },
        {
          name: 'Hazte Oír',
          desc: 'Plataforma de activismo cívico en España. Más de 600.000 seguidores defendiendo la vida, la familia y la libertad.',
          url: 'https://www.hazteoir.org',
          emoji: '📢',
        },
        {
          name: 'Copygen.ai',
          desc: 'Fábrica de startups. Equipos lean potenciados por agentes de IA trabajando 24/7.',
    ...
    contact: {
      title: 'Contacto',
      subtitle: '¿Quieres hablar? Escríbeme.',
      name: 'Nombre',
      email: 'Email',
      message: 'Mensaje',
      send: 'Enviar mensaje',
      ...
      error: 'Algo ha fallado. Inténtalo de nuevo o escríbeme directamente.',
    },
    footer: {
      copy: '© 2026 Ignacio Arsuaga',
    },
  },
  en: {
    nav: { lang: 'ES', langHref: '/' },
    hero: {
      name: 'Ignacio Arsuaga',
      subtitle: 'Founder. Entrepreneur. Activist.',
      scroll: 'Learn more',
    },
    bio: {
      title: 'About me',
    ...
    projects: {
      ...
      items: [
        {
          name: 'CitizenGO',
          desc: 'Global civic petition platform. 19M+ supporters across 50 countries.',
          url: 'https://citizengo.org',
          emoji: '🌍',
        },
        {
          name: 'Hazte Oír',
          desc: 'Civic activism platform in Spain. Over 600,000 supporters defending life, family, and freedom.',
          url: 'https://www.hazteoir.org',
          emoji: '📢',
        },
        {
          name: 'Copygen.ai',
          desc: 'Startup factory. Lean teams powered by AI agents working 24/7.',
          url: 'https://copygen.ai',
          emoji: '🤖',
        },
      ],
    ...
    contact: {
      title: 'Contact',
      subtitle: 'Want to talk? Drop me a message.',
      name: 'Name',
      email: 'Email',
      message: 'Message',
      send: 'Send message',
